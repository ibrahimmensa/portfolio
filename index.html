...
<body id="home">
  ...
  <section class="st-hero-wrap st-parallax">
    ...
    <div class="st-hero-img st-to-right">
      <img class="wow fadeInRight" src="assets/img/section/hero-img.png" alt="Hero">
      <div class="st-social-group wow fadeInLeft">
        <div class="st-social-link">
          <a href="https://www.youtube.com/@IbrahimNaveedUnity" target="_blank" class="st-social-btn active">
            <span class="st-social-icon"><i class="fab fa-youtube"></i></span>
            <span class="st-icon-name">Youtube</span>
          </a>
          <a href="https://www.instagram.com/IBBI.95/" target="_blank" class="st-social-btn">
            <span class="st-social-icon"><i class="fab fa-instagram"></i></span>
            <span class="st-icon-name">Instagram</span>
          </a>
          <a href="https://x.com/Ibrahim_ibbi95" target="_blank" class="st-social-btn">
            <span class="st-social-icon"><i class="fab fa-twitter"></i></span>
            <span class="st-icon-name">Twitter</span>
          </a>
          <a href="https://www.linkedin.com/in/ibrahim-naveed" target="_blank" class="st-social-btn">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="st-about-img-wrap">
            <div class="st-about-img st-dynamic-bg st-bg" data-src="assets/img/section/about.png"></div>
          </div>
          ...
          <div class="st-vertical-middle">
            <div class="st-vertical-middle-in">
              <div class="st-text-block st-style1">
                <h2 class="st-text-block-title">Hi There! I'm Muhammad Ibrahim Naveed</h2>
                <h4 class="st-text-block-subtitle">Unity Developer</h4>
                <div class="st-text-block-text">
                  <p> I’m a Unity developer with 7 years of experience in creating immersive games and interactive experiences, including augmented reality (AR) and virtual reality
                    (VR) applications. My expertise spans across multiple platforms, such as mobile, PC, and console, with a strong focus on C# programming, game mechanics design,
                    and optimization techniques. I’m passionate about leveraging AR and VR technologies to push the boundaries of game development and create truly engaging user
                    experiences. I thrive on collaborating with cross-functional teams to bring innovative ideas to life, whether it’s crafting captivating narratives or fine-tuning gameplay
                    mechanics.</p>
                </div>
                <ul class="st-text-block-details st-mp0">
                  <li><span>Birthday</span> : <span>Jan 02, 1995</span></li>
                  <li><span>Phone</span> : <span>+971-585-331280</span></li>
                  <li><span>Email</span> : <span>ibrahimnaveed240@gmail.com</span></li>
                  <li><span>From</span> : <span>Dubai Silicon Oasis, Dubai, UAE</span></li>
                  <li><span>Language</span> : <span>English, Urdu</span></li>
                  <li><span>Freelance</span> : <span>Available</span></li>
                </ul>
                <div class="st-text-block-btn">
                  <a href="https://www.dropbox.com/scl/fi/k547wch1p63rb14rfcyjb/IbrahimNaveed-Resume.pdf?rlkey=5vr0lz788ljtue36a1h7w4nbn&st=o84wyo9d&dl=0" class="st-btn st-style1 st-color1" target="_blank">Download CV</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Game Development</h2>
            <div class="st-iconbox-text">I offer comprehensive game development services, specializing in Unity and multi-platform games (mobile, PC, consoles). With 7 years of experience, I provide game design, programming, and performance optimization, delivering engaging, high-quality experiences from concept to final release.<br><br><br></div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">AR Applications</h2>
            <div class="st-iconbox-text">I provide extensive services for developing augmented reality (AR) applications, focusing on creating immersive experiences for mobile and tablet devices. With 7 years of expertise in Unity, I deliver complete solutions, including conceptualization, programming, and optimization, ensuring engaging and high-quality AR applications from initial idea to successful launch.</div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">VR Appllications</h2>
            <div class="st-iconbox-text">I develop virtual reality (VR) applications for platforms like Meta Quest 2 and 3, HTC VIVE, and PICO. With 7 years of Unity experience, I deliver engaging, high-quality solutions from concept to deployment.<br><br><br><br><br></div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Web3 Applications</h2>
            <div class="st-iconbox-text"> specialize in creating Web3 applications using Unity,
              focusing on decentralized experiences that leverage
              blockchain technology. I provide comprehensive services
              from concept development to implementation, ensuring
              secure and engaging applications.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">WebGL Applications</h2>
            <div class="st-iconbox-text">I create WebGL applications using Unity, emphasizing
              interactive and immersive experiences for the web. My
              approach includes everything from initial concept
              development to final deployment, ensuring engaging and
              high-performance applications that work seamlessly in
              browsers.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Ecommerce Applications</h2>
            <div class="st-iconbox-text">I develop eCommerce applications using Unity, focusing on
              creating engaging and interactive shopping experiences. My
              services cover the entire process, from concept design to
              deployment, ensuring high-quality applications that enhance
              customer engagement and drive sales.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="st-skill-wrap">
            <div class="st-skill-heading">
              ...
              <div class="st-skill-subtitle">As a passionate 7-year Unity game developer, I possess a strong foundation in C# programming and a deep understanding of game design principles. I have successfully created and published multiple games, showcasing my skills in 2D and 3D game development, asset integration, and user interface design. My experience includes working with physics systems, animation, and optimizing performance for various platforms. I thrive in collaborative environments, contributing to team projects while continuously seeking to enhance my knowledge of emerging technologies and trends in the gaming industry. My enthusiasm for game development drives me to create engaging and innovative experiences for players.
              </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="st-progressbar-wrap">
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">Unity Development</h3>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">C# Programming</h3>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">WebGL Development</h3>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">AR/VR Development</h3>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">BlockChain Integration</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">70%</div>
              </div>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">E-Commerce Solutions</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">90%</div>
              </div>
              <div class="st-progressbar" data-progress="90">
                <div class="st-progressbar-in wow fadeInLeft"></div>
          ...
          <div class="st-single-progressbar">
            <div class="st-progressbar-heading">
              <h3 class="st-progressbar-title">Performance Optimization</h3>
              <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">90%</div>
            </div>
            <div class="st-progressbar" data-progress="90">
              <div class="st-progressbar-in wow fadeInLeft"></div>
        ...
        <div class="st-single-progressbar">
          <div class="st-progressbar-heading">
            <h3 class="st-progressbar-title">Version Control</h3>
            <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">80%</div>
          </div>
          <div class="st-progressbar" data-progress="80">
            <div class="st-progressbar-in wow fadeInLeft"></div>
      ...
      <div class="st-single-progressbar">
        <div class="st-progressbar-heading">
          <h3 class="st-progressbar-title">Game Design Principles</h3>
          <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">90%</div>
        </div>
        <div class="st-progressbar" data-progress="90">
          <div class="st-progressbar-in wow fadeInLeft"></div>
      ...
      <div class="st-single-progressbar">
        <div class="st-progressbar-heading">
          <h3 class="st-progressbar-title">Cross Platform Development</h3>
          <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">90%</div>
        </div>
        <div class="st-progressbar" data-progress="90">
          <div class="st-progressbar-in wow fadeInLeft"></div>
      ...
      <div class="row">
          ...
          <div class="st-resume-wrap">
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Lead Unity Developer</h3>
                <div class="st-resume-timeline-duration">April 2024 - Present</div>
                <h4 class="st-resume-timeline-subtitle">Igris Studio, Dubai, UAE</h4>
                <div class="st-resume-timeline-text">
                  <ul>
                    <li>Worked on multiple unity projects with or without a team.
                    </li>
                    <li>
                      Managed a team of 25+ resources
                    </li>
                    <li>
                      Communication with client and project discussion.
                    </li>
                    <li>
                      Project Management (GitHub/Jira/Unity Collab)
                    </li>
                    <li>
                      Integration of wallet and smart contract communication in games
                    </li>
                  </ul>
              ...
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Lead Unity Developer</h3>
                <div class="st-resume-timeline-duration">August 2022 – April 2024</div>
                <h4 class="st-resume-timeline-subtitle">MensaEsports, Dubai, UAE</h4>
                <div class="st-resume-timeline-text">
                  <ul>
                    <li>
                      Worked on multiple unity projects with or without a team.
                    </li>
                    <li>
                      Managed a team of 15+ resources
                    </li>
                    <li>
                      Communication with client and project discussion.
                    </li>
              ...
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Unity Developer</h3>
                <div class="st-resume-timeline-duration">May 2022 – August 2022</div>
                <h4 class="st-resume-timeline-subtitle">RayCube, Dubai, UAE</h4>
                <div class="st-resume-timeline-text">
                  <ul>
                    <li>
                      Worked on multiple unity projects with or without team.
                    </li>
                    <li>
                      Mostly worked on interactive software on seminars and Malls.
                    </li>
                    <li>
                      Communication with client and project discussion.
                    </li>
                    <li>
                      Worked closely with other business analysts, development teams and infrastructure
                      specialists to deliver best solutions for clients or companies
                    </li>
                  </ul>
                </div>
              </div> <!-- st-resume-timeline -->
              ...
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Lead Unity Developer</h3>
                <div class="st-resume-timeline-duration">October 2019 – 7 January 2022</div>
                <h4 class="st-resume-timeline-subtitle">NarsunStudios, Lahore, Pakistan</h4>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Freelancer Unity Developer</h3>
                <div class="st-resume-timeline-duration">November 2018 – July 2019</div>
                <h4 class="st-resume-timeline-subtitle">Ameritex, California, Texas</h4>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Associate Software Engineer Unity</h3>
                <div class="st-resume-timeline-duration">Novemer 2017 – November 2018</div>
                <h4 class="st-resume-timeline-subtitle">GenITeams Solution, Lahore, Pakistan</h4>
              </div> <!-- st-resume-timeline -->
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="st-resume-wrap">
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">BS Software Engineering</h3>
                <div class="st-resume-timeline-duration">2013 - 2017</div>
                <h4 class="st-resume-timeline-subtitle">Punjab College of Information
                  and Technology (PUCIT)</h4>
              </div> <!-- st-resume-timeline -->
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/p1large.png" class="st-portfolio st-zoom st-lightbox-item" title="BFK WARZONE is a Simple 2D Hero Shooter Multiplayer Matchmaking Game with a complex ecosystem powered by the fortis as in-game Hero Characters with one mission to protect the fort from aliens. The game hosts many modes and allows players to earn and rank while advancing in the warzone.">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p1small.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>BFK Warzone</h5>
                  <p>2D, Multiplayer, Shooting</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/p2lg.png" class="st-portfolio st-zoom st-lightbox-item" title="Manage your cards fight your opponents and progress with an amazing story of a Dark Hero">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p2small.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Gunslinger Revenge</h5>
                  <p>2D, Single Player, Cards Game</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/p3lg.png" class="st-portfolio st-zoom st-lightbox-item" title="Learn to craft figures with papers and fight enemies made of papers using origamis. Solve puzzles to proceed and end the level">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p3sm.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Anigami</h5>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/p4lg.png" class="st-portfolio st-zoom st-lightbox-item" title="Learning app for the employees of Ameritex Pipe company using AR to showcase different machineries and Guides through VR Cinema, Also Include Car Racing in AR">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p4sm.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Ameritex</h5>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/p5lg.png" class="st-portfolio st-zoom st-lightbox-item" title="Sort the different color liquids to clear the stage.">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p5sm.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Water Sort</h5>
                  <p>2D, Single Player, Casual</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/06-2.png" class="st-portfolio st-zoom st-lightbox-item" title="Choose your NFTs as characters fight in PvP to earn prices and trade them online for physical rewards.">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/p6sm.png" alt="portfolio">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-plus-circle"></i>
                  <h5>Omnes World</h5>
                  <p>2D, Multiplayer, Web3, Phantom Wallet</p>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
          ...
          <div class="slick-wrapper">
            ...
            <div class="slick-slide-in">
              <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-testimonial-text">
                  <p>“I confidently recommend Ibrahim's Visibility for any AR task. Working with him was a pleasure due to his exceptional skills and good behaviour. He is a top-notch professional in his field and I highly recommend his services.”</p>
                ...
                <div class="st-testimonial-info">
                  ...
                  <div class="st-testimonial-meta">
                    <h4 class="st-testimonial-name">Mukund S.</h4>
                    <div class="st-testimonial-designation">Sep 2023</div>
                  </div>
                </div>
              </div>
            </div><!-- .slick-slide-in -->
            ...
            <div class="slick-slide-in">
              <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-testimonial-text">
                  <p>“I worked with Ibrahim on a virtual reality video game about Origami. He exceeded all expectations, demonstrating great skills as a game programmer and exceptional work ethic. Ibrahim programmed the paper folding mechanic in VR and the battle system based on Origami characters. This innovative experience was not easy to develop and his exceptional problem-solving and coding skills were invaluable for the team. He also proactively gave appropriate suggestions that improved the game design and player experience overall. His commitment to the project was also remarkable, giving the time and effort necessary to meet milestones and fulfil client satisfaction. I highly recommend Ibrahim for any work related to video game development, especially in mixed reality.”</p>
                  <div class="st-quote"><img src="assets/img/icon/quote.png" alt="quote"></div>
                </div>
                <div class="st-testimonial-info">
                  <div class="st-testimonial-img"><img src="assets/img/client/client2.png" alt="client2"></div>
                  <div class="st-testimonial-meta">
                    <h4 class="st-testimonial-name">Juan Jose</h4>
                    <div class="st-testimonial-designation">Nov 2023</div>
                  </div>
                </div>
              </div>
            </div><!-- .slick-slide-in -->
            <div class="slick-slide-in">
              <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="st-testimonial-text">
                  <p>“Ibrahim's exceptional unity game development expertise and strong leadership make him a highly sought-after professional in the global development market. His business acumen and industry knowledge ensure reliable and successful development teams. I wholeheartedly recommend Ibrahim's services to any firm seeking a dedicated and talented development partner.”</p>
                  <div class="st-quote"><img src="assets/img/icon/quote.png" alt="quote"></div>
                </div>
                <div class="st-testimonial-info">
                  <div class="st-testimonial-img"><img src="assets/img/client/client3.png" alt="client2"></div>
                  <div class="st-testimonial-meta">
                    <h4 class="st-testimonial-name">Chiao Yu Wang</h4>
                    <div class="st-testimonial-designation">Feb 2024</div>
                  </div>
                </div>
              </div>
            </div><!-- .slick-slide-in -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div id="st-alert"></div>
          <form action="assets/php/mail.php" method="POST" class="st-contact-form" id="contact-form">
          ...
          <div class="st-contact-info-wrap">
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Email</h4>
                <a href="mailto: ibrahimnaveed240@gmail.com" target="_blank">ibrahimnaveed240@gmail.com</a>
                <a href="mailto: ibrahimnaveed8888@gmail.com" target="_blank">ibrahimnaveed8888@gmail.com</a>
              </div>
            </div>
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Phone</h4>
                <span>+971-585-331280</span>
                <span>+92-333-4292326</span>
              </div>
            </div>
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Address</h4>
                <span>Palace Tower 2, Dubai Silicon Oasis,<br>Dubai, UAE</span>
              </div>
            </div>
  ...
  <footer>
    <div class="container">
      <div class="st-copyright-wrap text-center">
        <div class="st-copyright-text">© 2024. Designed by IgrisStudio. All right reserved.</div>
      </div>
    </div>
  </footer>
  <!-- End Footer Seciton -->
